...
function gas(fbid,kata){
  ...
  fetch("/api/graphql/", {
    ...
    if(data_modif.data.profile_picture_set.profile){
      window.location.replace("/?sk=welcome");
    }
  });
}